...
# Script untuk build dan push Docker image untuk aplikasi backend Karsa Jobs
...
# ==============================================================
echo "Building Docker image: ${USERNAME}/karsajobs:${TAG}"
docker build -t ${USERNAME}/karsajobs:${TAG} -t ${USERNAME}/karsajobs:latest .
...
# ==============================================================
echo "Pushing image to Docker Hub: ${USERNAME}/karsajobs:${TAG}"
docker push ${USERNAME}/karsajobs:${TAG}
